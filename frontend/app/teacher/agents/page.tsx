    ...
    <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 inline-flex items-center gap-1 rounded-full bg-ink-warning-light px-2 py-0.5 text-[10px] font-semibold text-ink-warning">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-dashed border-ink-border bg-white p-8 text-center">
          ...
          <p className="mt-3 text-sm font-medium text-ink-text">还没有 Agent 实例</p>
          <p className="mt-1 text-xs text-ink-text-muted">
            先选择课程后创建 Agent，即可开启答疑、批注和练习等能力。
          </p>
        </div>
      )}
    </motion.div>
