  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {isDemoMode && (
          <p className="mt-2 inline-flex items-center gap-1 rounded-full bg-ink-warning-light px-2 py-0.5 text-[10px] font-semibold text-ink-warning">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
        ...
        >
          ...
          {masteryData.length > 0 ? (
            ...
            <div className="flex h-[300px] items-center justify-center rounded-lg border border-dashed border-ink-border bg-ink-surface/40 text-center">
        ...
        >
          ...
          <div className="space-y-3">
            {warningData.length > 0 ? (
              ...
              <div className="rounded-lg border border-dashed border-ink-border bg-ink-surface/40 p-6 text-center">
                <p className="text-xs text-ink-text-muted">
                  当前没有预警学生。
                  <br />
                  系统识别到风险后会自动列在这里。
