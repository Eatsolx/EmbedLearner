...
const quickActions = [
  { label: "什么是感知机？", icon: "ri-question-line" },
  { label: "帮我批改这道搜索算法题", icon: "ri-file-edit-line" },
  { label: "练习机器学习基础", icon: "ri-focus-3-line" },
  { label: "总结人工智能引论本章重点", icon: "ri-book-open-line" },
];
